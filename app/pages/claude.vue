...
const presets = [
  ...
  { id: 'mariadb',     label: 'MariaDB',       image: 'mariadb:lts',               icon: '🦭', defaultPorts: ['3306:3306'],                defaultEnv: ['MARIADB_ROOT_PASSWORD=secret','MARIADB_DATABASE=app'] },
  { id: 'elasticsearch',label: 'Elasticsearch',image: 'elasticsearch:8.13.0',      icon: '🔍', defaultPorts: ['9200:9200','9300:9300'],    defaultEnv: ['discovery.type=single-node','xpack.security.enabled=false'] },
  { id: 'prometheus',  label: 'Prometheus',    image: 'prom/prometheus:latest',    icon: '🔥', defaultPorts: ['9090:9090'],                defaultEnv: [] },
  { id: 'golang',      label: 'Go',            image: 'golang:1.22-alpine',        icon: '🐹', defaultPorts: ['8080:8080'],                defaultEnv: [] },
  { id: 'php',         label: 'PHP',           image: 'php:8.3-fpm-alpine',        icon: '🐘', defaultPorts: ['9000:9000'],                defaultEnv: [] },
  { id: 'wordpress',   label: 'WordPress',     image: 'wordpress:latest',          icon: '📝', defaultPorts: ['80:80'],                    defaultEnv: ['WORDPRESS_DB_USER=root','WORDPRESS_DB_PASSWORD=secret'] },
  { id: 'portainer',   label: 'Portainer',     image: 'portainer/portainer-ce',    icon: '🚢', defaultPorts: ['8000:8000','9443:9443'],    defaultEnv: [] },
  { id: 'cloudflared', label: 'Cloudflared',   image: 'cloudflare/cloudflared',    icon: '🕳️', defaultPorts: [],                           defaultEnv: ['TUNNEL_TOKEN=your_token_here'] },
  { id: 'uptimekuma',  label: 'Uptime Kuma',   image: 'louislam/uptime-kuma:1',    icon: '⏱️', defaultPorts: ['3001:3001'],                defaultEnv: [] },
  { id: 'kafka',       label: 'Kafka',         image: 'confluentinc/cp-kafka',     icon: '🚀', defaultPorts: ['9092:9092'],                defaultEnv: ['KAFKA_ADVERTISED_LISTENERS=PLAINTEXT://kafka:9092','KAFKA_ZOOKEEPER_CONNECT=zookeeper:2181'] },
  { id: 'zookeeper',   label: 'ZooKeeper',     image: 'confluentinc/cp-zookeeper', icon: '🦒', defaultPorts: ['2181:2181'],                defaultEnv: ['ZOOKEEPER_CLIENT_PORT=2181'] },
  { id: 'jenkins',     label: 'Jenkins',       image: 'jenkins/jenkins:lts',       icon: '👨‍🍳', defaultPorts: ['8080:8080','50000:50000'],  defaultEnv: [] },
  { id: 'gitea',       label: 'Gitea',         image: 'gitea/gitea:latest',        icon: '🍵', defaultPorts: ['3000:3000','2222:22'],      defaultEnv: ['USER_UID=1000','USER_GID=1000'] },
  { id: 'kali',        label: 'Kali Linux',    image: 'kalilinux/kali-rolling',    icon: '🐉', defaultPorts: [],                           defaultEnv: [] },
  { id: 'memcached',   label: 'Memcached',     image: 'memcached:alpine',          icon: '⚡', defaultPorts: ['11211:11211'],              defaultEnv: [] },
  { id: 'vaultwarden', label: 'Vaultwarden',   image: 'vaultwarden/server:latest', icon: '🛡️', defaultPorts: ['80:80'],                    defaultEnv: [] },
